...
$page_title = 'TKA Matematika SD/MI';
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col items-center space-y-3 mb-4" data-aos="fade-up">
                ...
                <div class="text-center">
                     <h1 class="text-3xl md:text-4xl font-extrabold text-slate-800">Matematika</h1>
                     <p class="text-lg text-slate-600">Latihan Soal TKA Matematika Jenjang SD/MI</p>
                </div>
            </div>
            ...
            <nav class="flex items-center justify-center text-sm text-slate-500" data-aos="fade-up">
                ...
                <i data-lucide="chevron-right" class="w-4 h-4 mx-1"></i>
                <span class="font-medium text-slate-700">Matematika</span>
            </nav>
