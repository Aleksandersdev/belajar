...
$page_title = 'TKA SMP / MTs';
$show_tka_modal = true;

// --- Data Modal Kustom untuk SMP ---
...
<main>
    <section class="py-20 bg-slate-50">
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col items-center space-y-3 mb-4" data-aos="fade-up"> <div class="flex-shrink-0 bg-purple-100 p-3 rounded-xl"> <i data-lucide="graduation-cap" class="w-8 h-8 text-purple-600"></i>
                </div>
                <div class="text-center">
                     <h1 class="text-3xl md:text-4xl font-extrabold text-slate-800">TKA SMP / MTs</h1>
                     <p class="text-lg text-slate-600">Pilih mata pelajaran untuk mulai belajar.</p>
                </div>
            </div>

            <nav class="flex items-center justify-center text-sm text-slate-500" data-aos="fade-up"> <a href="/" class="hover:underline">Home</a>
                <i data-lucide="chevron-right" class="w-4 h-4 mx-1"></i>
                <a href="/tka" class="hover:underline">Portal TKA</a>
                <i data-lucide="chevron-right" class="w-4 h-4 mx-1"></i>
                <span class="font-medium text-slate-700">TKA SMP / MTs</span>
            </nav>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="w-full md:w-3/4 order-1 md:order-2">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <a href="#" class="group block bg-white rounded-2xl p-6 shadow-lg border border-slate-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/20" data-aos="fade-up" data-aos-delay="150">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500">Asah kemampuan berhitung, logika, aljabar, dan geometri dasar.</p>
                                </div>
                            </div>
                        </a>
